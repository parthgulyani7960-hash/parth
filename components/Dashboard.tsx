...
const features = [
  ...
  { id: AppFeature.PixelArt, name: 'Pixel Art Studio', description: 'Generate retro pixel art and convert your photos into sprites.', icon: 'layout-grid' as const, color: 'text-blue-500' },
